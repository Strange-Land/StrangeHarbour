...
public class CloudRenderer : MonoBehaviour
{
    ...
    [SerializeField] float skyboxScale = 1000f;
    ...
    private void OnEnable()
    {
        ...
        //PlanarReflections.BeginPlanarReflections += RenderPipelineManagerOnbeginCameraRendering;//ToDo CHatGPT Upgrade
    ...
    public void DrawClouds(Camera camera)
    {
        ...
        for (var index = 0; index < aliveCount; index++)
        {
            ...
            var pos = particle.position * skyboxScale + camPos * (1 - skyboxScale);
            ...
            Graphics.DrawMesh(mesh, Matrix4x4.TRS(pos, q, scale * skyboxScale),
